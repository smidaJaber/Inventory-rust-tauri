			...
			rightSection={
				<Group noWrap>
					...
					{props.withModification && (
						<ActionIcon title="Create" onClick={openCreator}>
		...
		>
							...
							<Group
								...
								sx={(theme) => ({
									backgroundColor: isActive
										? theme.fn.rgba(theme.fn.themeColor("surreal"), 0.125)
										: undefined,
									borderRadius: 8,
								})}
							>
			...
			>
				<Text color={isLight ? "light.6" : "light.1"}>
					You are about to delete this table. This action cannot be undone, and
					all data within it will be lost.
				</Text>
				<Group mt="lg">
					<Button
						onClick={closeDelete}
