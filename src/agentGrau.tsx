...
export interface GrauConnection {
	namespace: string;
	database: string;
	endpoint: string;
	username: string;
...
export interface GrauOptions {
	connection: GrauConnection;
	onConnect?: () => void;
	onDisconnect?: (code: number, reason: string) => void;
	onError?: (error: any) => void;
}

export interface GrauHandle {
	close(): void;
...
function createGrau(options: GrauOptions): GrauHandle {
...
let instance: GrauHandle | null = null;

/**
 * Open a connection to the given database
 */
export function openGrau(options: GrauOptions) {
	instance?.close();
	instance = createGrau(options);
}

/**
 * Retrieve the current database connection
 */
export function getGrau(): GrauHandle | null {
	return instance;
}
